...
export default function HomeBanner() {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute bottom-[20%] lg:bottom-8 m-auto w-full">
        ...
        >
          <button
            style={{
              background:
                "linear-gradient(108.28deg, #72CEFF 6.47%, #27608B 91.92%)",
              borderImageSource:
                "linear-gradient(108.28deg, #27608B 6.47%, #72CEFF 91.92%)",
            }}
            className="gradient-border-button-one m-auto mt-6  "
          >
        ...
        .gradient-border-button-one:hover {
          box-shadow: 2px 4px 8px rgba(137, 135, 135, 0.5);
        }
        .gradient-border-button-one::before {
          content: "";
          position: absolute;
          inset: 0;
          border-radius: 10px;
