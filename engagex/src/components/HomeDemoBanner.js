...
import "./HomeDemoBanner.style.css";

export default function HomeDemoBanner() {
      ...
      <div className="relative h-screen w-full overflow-hidden">
        ...
        <div className="svg-container">
          <svg
            ...
            className="transform-transition cursor-pointer svgClass"
            width={!isAnimating ? "460" : window.innerWidth}
            height={!isAnimating ? "400" : window.innerHeight}
            viewBox={`0 0 ${!isAnimating ? "460" : window.innerWidth * 0.6} ${
              !isAnimating ? "400" : window.innerHeight * 0.6
            }`}
          >
            <defs>
              <clipPath id="starClip" className={isAnimating ? "animate" : ""}>
                <path
                  className={
                    isAnimating ? "starClipShape animate" : "starClipShape"
                  }
            ...
            >
              <video
                ...
                loop
                playsInline
                className="absolute w-full h-full inset-0 object-cover absolute"
